...
export default function About() {
  ...
  // useEffect(() => {
  //   const beam = projectorBeamRef.current;
  //   if (!beam) return;

  //   const beamInterval = setInterval(() => {
  //     const xParticle = Math.random() * beam.offsetWidth;
  //     const newParticle = document.createElement("div");
  //     newParticle.className = "projectile-particle";
  //     newParticle.style.left = `${xParticle}px`;
  //     // beam.appendChild(newParticle);
  //   }, 3000);
